...
class Bird:
    ...
    def move(self):
        ...
        #Tilting bird upword when going up to a max of 25 deg
    ...
    def draw(self, win):
        ...
        self.img_count +=1
        #Alternating between images so the wings flaps
        ...
        if self.img_count < self.ANIMATION_TIME:
            ...
            self.img = self.IMGS[0]
            self.img_count = 0
        #When Bird goes down, it's not flapping its wings
...
def draw_window(win, bird, pipes, base, score):
    #draw anything pass to on the screen
    win.blit(BG_IMG, (0,0))
